...
class Dispatcher {
	...
	static private function getSpace($var, $urlCase) {
		...
		unset($_GET[$var]);
		return self::cleanNotWords($space);
	}
	...
	static private function getAction($var, $urlCase) {
		...
		return self::cleanNotWords(strip_tags($urlCase ? strtolower($action) : $action));
	}
	...
	static private function getModule($var) {
		...
		return self::cleanNotWords(strip_tags(ucfirst($module)));
	}
